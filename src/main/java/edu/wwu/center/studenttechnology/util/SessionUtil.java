...
public class SessionUtil {
    ...
    public static void setIntentToHandleNextYesNo(Session session, String intentName) {
    ...
    public static final void setIntentToHandleNextEvent(Session session, String intentName) {
